...
main() {
  ...
  case "$target" in
    ...
    cross-bot)
      ...
      echo ""
      echo "Cross-bot stack installed."
      echo "  1. ./scripts/configure-crossbot.sh   — roster com profiles reais"
      echo "  2. ./scripts/setup-crossbot-board.sh"
      echo "  3. docs/onboarding/02-instalar-e-adaptar.md"
      ;;
    all)
